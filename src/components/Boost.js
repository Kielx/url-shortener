...
const Boost = () => {
  ...
  return (
    ...
    >
      ...
      <button className="mb-20 mt-6 m-auto  whitespace-nowrap inline-flex items-center justify-center lg:px-10 px-4 py-3 border border-transparent rounded-full shadow-sm text-base font-bold text-white bg-cyan hover:bg-teal-500">
        Get started
      </button>
    </div>
  );
