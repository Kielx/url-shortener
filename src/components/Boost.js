...
const Boost = () => {
  ...
  return (
    ...
    >
      ...
      <button className="mb-20 mt-6 m-auto w-1/4 max-w-xs whitespace-nowrap inline-flex items-center justify-center px-4 py-3 border border-transparent rounded-full shadow-sm text-base font-bold text-white bg-cyan hover:bg-teal-500">
        Get started
      </button>
    </div>
  );
