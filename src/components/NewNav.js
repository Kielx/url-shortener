  ...
  return (
    <Popover className="relative bg-gray-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6">
        <div className="flex justify-between items-center  py-6 md:justify-start md:space-x-10">
          ...
          <div className="mr-2 -my-2 md:hidden">
            <Popover.Button className="bg-gray-50 rounded-md p-2 inline-flex items-center justify-center text-gray-400 hover:text-white hover:bg-cyan focus:outline-none focus:ring-2 focus:ring-inset focus:ring-indigo-500">
      ...
      >
        <Popover.Panel
          focus
          className="absolute top-0 right-2 inset-x-0 p-2 transition transform origin-top-right md:hidden"
        >
